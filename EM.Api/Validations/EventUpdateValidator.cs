...
namespace EM.Api.Validations
{
    public class EventUpdateValidator : AbstractValidator<EventUpdateDTO>
    {
        ...
        public EventUpdateValidator(IPerformerRepository performerRepo, IVenueRepository venueRepo)
        {
        ...
        private bool ValidateDate(EventUpdateDTO e)
        {
        ...
        private bool ValidateStartDate(EventUpdateDTO e)
        {
            DateTime startDateTime;
            bool isValidStartTime = DateTime.TryParseExact(e.StartDateTime, "yyyy-MM-ddTHH:mm:ssZ", null, System.Globalization.DateTimeStyles.None, out startDateTime);
        ...
        private bool ValidateDateRange(EventUpdateDTO e)
        {
            DateTime startDateTime;
            bool isValidStartTime = DateTime.TryParseExact(e.StartDateTime, "yyyy-MM-ddTHH:mm:ssZ", null, System.Globalization.DateTimeStyles.None, out startDateTime);
            DateTime endDateTime;
